...
public final class FragmentAccountBinding implements ViewBinding {
  ...
  private FragmentAccountBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogout,
      @NonNull TextView tvProfileInfo) {
  ...
  public static FragmentAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvProfileInfo;
      TextView tvProfileInfo = ViewBindings.findChildViewById(rootView, id);
      if (tvProfileInfo == null) {
        break missingId;
      }

      return new FragmentAccountBinding((ScrollView) rootView, btnLogout, tvProfileInfo);
    }
