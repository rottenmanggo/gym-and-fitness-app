...
public class Main extends Application {
    ...
    // logoTitle.setStyle("-fx-font-size: 18px; -fx-font-weight: 900; -fx-text-fill:
    // #0f172a;");
    // Label logoSub = new Label("ADMIN PANEL");
    // logoSub.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill:
    // #94a3b8;");
    ...
    // uName.setStyle("-fx-font-size: 13px; -fx-font-weight: 900; -fx-text-fill:
    // #0f172a;");
    ...
    // sidebar.getChildren().addAll(logoBox, menuLabel, nav, spacer, userBox,
    // logoutWrapper);
    // return sidebar;
    // }
    ...
    // title.setStyle("-fx-font-size: 26px; -fx-font-weight: 900; -fx-text-fill:
    // #0f172a;");

    // Label desc = new Label(
    // "Halaman ini masih dalam tahap pengembangan dan akan dikerjakan oleh anggota
    // tim terkait.");
    // desc.setWrapText(true);
    // desc.setStyle("-fx-font-size: 14px; -fx-text-fill: #64748b; -fx-line-spacing:
    // 4;");
