...
public class MemberController {
    ...
    private void openAddMember(ActionEvent event) {
        SceneManager.changeScene(
                ...
                "/com/gymbrut/resources/fxml/admin/member/AddMember.fxml",
    ...
    private void openEditMember(ActionEvent event) {
        ...
        SceneManager.changeScene(
                (Node) event.getSource(),
                "/com/gymbrut/resources/fxml/admin/member/EditMember.fxml",
                "GYMBRUT - Edit Member",
                1280,
                760);
    }
    ...
    private void handleLogout(ActionEvent event) {
        ...
        SceneManager.changeScene(
                (Node) event.getSource(),
                "/com/gymbrut/resources/fxml/auth/Login.fxml",
                "GYMBRUT - Login",
                1100,
                720);
    }
