...
public class AdminMemberController {
    ...
    @FXML private TableColumn<Member, Void> colAction;
    ...
    public void initialize() {
        ...
        colMembership.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getMembership()));
        colJoinDate.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getJoinDate()));
